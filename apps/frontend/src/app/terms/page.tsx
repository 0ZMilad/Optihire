    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-muted-foreground [&_h2]:mt-8 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-foreground">
          <p>
            By accessing or using OptiHire ("the Service"), you agree to be
          ...
          <p>
            OptiHire is provided for personal, non-commercial use to help
            individuals improve their resumes and discover job opportunities.
          ...
          <p>
            You retain ownership of any resumes or documents you upload. By
            uploading content, you grant OptiHire a limited licence to process
            that content solely to provide the Service to you.
          </p>

          <h2>4. AI-Generated Suggestions</h2>
          <p>
            Suggestions provided by our AI tools are for informational purposes
            only. OptiHire does not guarantee employment outcomes and accepts no
            liability for decisions made based on AI-generated content.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
            All software, design, and content comprising the OptiHire platform
            (excluding your uploaded content) is owned by OptiHire and protected
          ...
          <p>
            ...
            Service at any time for violations of these Terms or for any other
            reason at our discretion.
          </p>

          <h2>7. Limitation of Liability</h2>
          <p>
            To the fullest extent permitted by law, OptiHire shall not be liable
