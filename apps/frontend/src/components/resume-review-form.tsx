        ...
        <div className="space-y-2">
          ...
          <div className="flex">
            ...
            <Input
              ...
              onChange={(e) =>
                onLinkedInChange(
                  e.target.value ? buildLinkedInUrl(e.target.value) : ""
                )
              }
              placeholder="johndoe"
          ...
          <div className="flex flex-wrap gap-1.5 min-h-[24px]">
            {skills.map((skill, index) => (
              <div key={index} className="relative group">
                <Badge variant="secondary" className="px-2 py-1 text-xs pr-6">
                  {skill.skill_name}
                  <button
                    type="button"
...
const ExperienceSection = memo(
  ({
    ...
    const updateExperience = (
      index: number,
      updates: Partial<ExperienceRead>
    ) => {
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          {experiences.map((exp, index) => (
            <div
              key={index}
              className="p-3 rounded-md border bg-muted/20 relative"
            >
              {editingIndex === index ? (
                <div className="space-y-3">
          ...
          {isAdding && (
            <div className="p-3 rounded-md border border-dashed border-primary/50 bg-primary/5">
              <div className="flex items-center justify-between">
                <p className="text-xs text-muted-foreground">
                  Click "Add" to create a new experience entry
                </p>
                <div className="flex gap-2">
                  <Button
                    type="button"
        ...
        <div className="space-y-3">
          ...
          {isAdding && (
            <div className="p-3 rounded-md border border-dashed border-primary/50 bg-primary/5">
              <div className="flex items-center justify-between">
                <p className="text-xs text-muted-foreground">
                  Click "Add" to create a new education entry
                </p>
                <div className="flex gap-2">
                  <Button
                    type="button"
...
export function ResumeReviewForm({
  ...
  const { firstName: initialFirstName, lastName: initialLastName } =
    parseFullName(resumeData.full_name || "");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logger.error("Failed to save resume form", {
  ...
  return (
    <div className="h-full w-full">
      ...
      <div
        className={`h-full flex flex-col ${useSplitView ? "lg:flex-row lg:gap-6" : ""}`}
      >
        ...
        <div
          className={`${useSplitView ? "lg:w-1/2 lg:h-full lg:overflow-y-auto" : "max-w-3xl mx-auto"} flex-1 min-h-0`}
        >
