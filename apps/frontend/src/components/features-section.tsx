      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          <div className="lg:col-span-7 lg:order-1 lg:sticky lg:top-[100px] lg:self-start">
            <div className="relative w-full aspect-[4/3] lg:aspect-[16/9] rounded-2xl overflow-hidden bg-muted border border-border shadow-xl">
              <div className="absolute top-0 left-0 right-0 h-12 bg-card border-b border-border flex items-center px-4 gap-2 z-10">
                <div className="w-3 h-3 rounded-full bg-red-400/80"></div>
                <div className="w-3 h-3 rounded-full bg-yellow-400/80"></div>
                <div className="w-3 h-3 rounded-full bg-green-400/80"></div>
              </div>
              <div className="absolute top-12 left-0 right-0 bottom-0 bg-muted">
                <Image
                  src="/Optihire 4K.png"
            ...
            <div className="mt-8 bg-card rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-border p-8">
              <div className="grid grid-cols-3 gap-4 divide-x divide-border">
                <div className="text-center px-2">
                  <div className="text-3xl font-bold text-foreground">
                    10k<span className="text-brand-primary">+</span>
                  </div>
                ...
                <div className="text-center px-2">
                  <div className="text-3xl font-bold text-foreground">
                    500<span className="text-brand-primary">+</span>
                  </div>
                  <div className="text-sm font-medium text-muted-foreground uppercase tracking-wide mt-1">
                    Companies Hiring
                  </div>
                ...
                <div className="text-center px-2">
                  <div className="text-3xl font-bold text-foreground">
                    3<span className="text-brand-primary">x</span>
                  </div>
                  <div className="text-sm font-medium text-muted-foreground uppercase tracking-wide mt-1">
                    Faster Interviews
                  </div>
            ...
            <div className="mt-4 bg-card rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-border p-4 flex items-center justify-between gap-4">
