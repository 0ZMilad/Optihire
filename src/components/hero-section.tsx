      ...
      <div className="grid items-center gap-8 md:gap-10 lg:gap-12 xl:gap-16 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)] xl:grid-cols-[minmax(0,520px)_minmax(0,1fr)]">
        <div className="mx-auto max-w-2xl space-y-6 sm:space-y-8 text-center lg:mx-0 lg:text-left">
          <div className="flex justify-center lg:justify-end">
            <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-primary lg:mr-35">
        ...
        <div className="relative mx-auto w-full max-w-xl hidden md:block">
          ...
          <div className="relative overflow-hidden rounded-2xl md:rounded-3xl lg:rounded-[32px] border border-border bg-white/60 p-4 sm:p-6 lg:p-8 shadow-[0_40px_120px_-45px_rgba(15,23,42,0.65)] backdrop-blur scale-90 md:scale-95 lg:scale-100 origin-center">
            <div className="flex flex-col gap-4 sm:gap-5 lg:gap-6">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="rounded-full bg-emerald-500/10 px-2.5 sm:px-3 lg:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-emerald-600 whitespace-nowrap">
                  Top 5%
                </span>
              </div>

              <div className="grid gap-3 sm:gap-4 rounded-2xl lg:rounded-3xl bg-muted/30 p-4 sm:p-5 lg:p-6">
              ...
              <div className="rounded-2xl lg:rounded-3xl bg-primary/10 p-4 sm:p-5 lg:p-6 text-xs sm:text-sm text-primary">
